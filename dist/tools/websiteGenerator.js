...
exports.generateWebsiteStructure = void 0;
const workflows_1 = require("@mastra/core/workflows");
const zod_1 = require("zod");
exports.generateWebsiteStructure = (0, workflows_1.createStep)({
...
function extractStyleFromText(text) {
    ...
    if (lowerText.includes('minimal') || lowerText.includes('clean'))
        return 'minimal';
    if (lowerText.includes('modern') || lowerText.includes('contemporary'))
        return 'modern';
    if (lowerText.includes('corporate') || lowerText.includes('professional'))
        return 'corporate';
    if (lowerText.includes('creative') || lowerText.includes('artistic'))
        return 'creative';
    if (lowerText.includes('bold') || lowerText.includes('vibrant'))
        return 'bold';
